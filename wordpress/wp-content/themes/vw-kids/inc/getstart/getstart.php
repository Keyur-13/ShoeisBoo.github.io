					...
					<div class="info-link">
			  		...
			  		<div class="link-customizer">
						...
						<div class="first-row">
							...
							<div class="row-box">
								<div class="row-box1">
									<span class="dashicons dashicons-images-alt"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_kids_post_settings') ); ?>" target="_blank"><?php esc_html_e('Post settings','vw-kids'); ?></a>
								</div>
								 <div class="row-box2">
