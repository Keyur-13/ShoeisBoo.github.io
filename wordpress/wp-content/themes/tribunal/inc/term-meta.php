<?php
if( !function_exists('tribunal_custom_taxonomy_field') ):

	// Add term page
    function tribunal_custom_taxonomy_field(){

        // this will add the custom meta field to the add new term page ?>

        <div class="form-field">
            
            <label><?php esc_html_e('Feature Image', 'tribunal'); ?></label>
...
add_action('category_add_form_fields', 'tribunal_custom_taxonomy_field', 10, 2);


if( !function_exists('tribunal_taxonomy_edit_meta_field') ):

	// Edit term page
    function tribunal_taxonomy_edit_meta_field($term){
        ...
        <tr>
            ...
            <th scope="row" valign="top"><label><?php esc_html_e('Feature Image', 'tribunal'); ?></label></th>
...
add_action('category_edit_form_fields', 'tribunal_taxonomy_edit_meta_field', 10, 2);
