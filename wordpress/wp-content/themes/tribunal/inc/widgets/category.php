...
if ( !function_exists('tribunal_category_widgets') ) :
     ...
     * @since 1.0.0
     */
    function tribunal_category_widgets(){
        // Recent Post widget.
        register_widget('Tribunal_Sidebar_Category_Widget');

    }

endif;
add_action('widgets_init', 'tribunal_category_widgets');

// Recent Post widget
if ( !class_exists('Tribunal_Sidebar_Category_Widget') ) :
     ...
     * @since 1.0.0
     */
    class Tribunal_Sidebar_Category_Widget extends Tribunal_Widget_Base
    {
        ...
        {
            $opts = array(
                'classname' => 'tribunal_category_widget',
                'description' => esc_html__('Displays categories and posts.', 'tribunal'),
            ...
            $fields = array(
                ...
                'top_category' => array(
                    'label' => esc_html__('Top Categories:', 'tribunal'),
                    'type' => 'number',
                    'default' => 5,
                    'css' => 'max-width:60px;',
                    'min' => 1,
                ...
                'enable_cat_desc' => array(
                    'label' => esc_html__('Enable Category Description:', 'tribunal'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
            );

            parent::__construct('tribunal-category-layout', esc_html__('Tribunal: Category Widget', 'tribunal'), $opts, array(), $fields);
        }
                                    ...
                                    while( $cat_posts->have_posts() ){
                                        ...
                                        <div class="category-latest-article">
                                            <h3 class="entry-title entry-title-small">
                                                ...
                                                <span class="latest-category-post"><?php esc_html_e('Latest :','tribunal'); ?></span>
