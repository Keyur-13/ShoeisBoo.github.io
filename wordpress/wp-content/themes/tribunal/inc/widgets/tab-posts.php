...
if ( !function_exists('tribunal_tab_posts_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function tribunal_tab_posts_widgets(){
        // Tab Post widget.
        register_widget('Tribunal_Tab_Posts_Widget');

    }
endif;
add_action('widgets_init', 'tribunal_tab_posts_widgets');

/* Tabed widget */
if ( !class_exists('Tribunal_Tab_Posts_Widget') ):
     ...
     * @since 1.0.0
     */
    class Tribunal_Tab_Posts_Widget extends Tribunal_Widget_Base {
        ...
        function __construct() {
            ...
            $opts = array(
                'classname'   => 'tribunal_widget_tabbed',
                'description' => esc_html__('Tabbed widget.', 'tribunal'),
            );
            $fields = array(
                'popular_heading' => array(
                    'label'          => esc_html__('Popular', 'tribunal'),
                    'type'           => 'heading',
                ),
                'popular_number' => array(
                    'label'         => esc_html__('No. of Posts:', 'tribunal'),
                    'type'          => 'number',
                    'css'           => 'max-width:60px;',
                    'default'       => 5,
                    'min'           => 1,
                ...
                'enable_discription' => array(
                    'label'             => esc_html__('Enable Description:', 'tribunal'),
                    'type'              => 'checkbox',
                    'default'           => true,
                ),
                'select_image_size' => array(
                    'label' => esc_html__('Select Image Size Featured Post:', 'tribunal'),
                    'type' => 'select',
                    'default' => 'medium',
                    'options' => array(
                        'thumbnail' => esc_html__('Thumbnail', 'tribunal'),
                        'medium' => esc_html__( 'Medium', 'tribunal' ),
                        'large' => esc_html__( 'Large', 'tribunal' ),
                        'full' => esc_html__( 'Full', 'tribunal' ),
                        ),
                    
                ),
                'excerpt_length' => array(
                    'label'         => esc_html__('Excerpt Length:', 'tribunal'),
                    'description'   => esc_html__('Number of words', 'tribunal'),
                    'default'       => 10,
                    'css'           => 'max-width:60px;',
                    'min'           => 0,
                    'max'           => 200,
                ...
                'recent_heading' => array(
                    'label'         => esc_html__('Recent', 'tribunal'),
                    'type'          => 'heading',
                ),
                'recent_number' => array(
                    'label'        => esc_html__('No. of Posts:', 'tribunal'),
                ...
                'comments_heading' => array(
                    'label'           => esc_html__('Comments', 'tribunal'),
                    'type'            => 'heading',
                ),
                'comments_number' => array(
                    'label'          => esc_html__('No. of Comments:', 'tribunal'),
                    'type'           => 'number',
                    'css'            => 'max-width:60px;',
                    'default'        => 5,
                    'min'            => 1,
            ...
            parent::__construct( 'tribunal-tabbed', esc_html__( 'Tribunal: Tab Posts Widget', 'tribunal' ), $opts, array(), $fields );
                    ...
                    <ul class="twp-nav-tabs clear">
                        ...
                        <li id="tab-popular-<?php echo esc_attr( $args['widget_id'] ); ?>" class="tab tab-popular active">
                            <a href="javascript:void(0)">
                                ...
                                <?php esc_html_e( 'Popular', 'tribunal' );?>
                            </a>
                        </li>
                        ...
                        <li id="tab-recent-<?php echo esc_attr( $args['widget_id'] ); ?>" class="tab tab-recent">
                            <a href="javascript:void(0)">
                                ...
                                <?php esc_html_e('Recent', 'tribunal');?>
                            </a>
                        </li>
                        ...
                        <li id="tab-comments-<?php echo esc_attr( $args['widget_id'] ); ?>" class="tab tab-comments">
                            <a href="javascript:void(0)">
                                ...
                                <?php esc_html_e('Comments', 'tribunal');?>
                            </a>
                        </li>
