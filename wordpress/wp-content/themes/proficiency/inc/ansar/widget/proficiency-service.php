<?php
add_action('admin_enqueue_scripts', 'proficiency_service_widget');

function proficiency_service_widget() {    
...
class proficiency_service_widget extends WP_Widget {    
    ...
    <div class="col-sm-4 col-md-4">
            <div class="proficiency-service">
                <div class="proficiency-service-inner">
                    ...
                    <div class="proficiency-service-inner-img"> 
	...
	?>
				...
				<td>
				  <label for="<?php echo $this->get_field_id( 'fa_icon' ); ?>"><?php _e( 'Enter  Font Awesome icon class ( like: fa-cloud ). <a href="//fontawesome.io/fa_icons/" target="blank" >Here all icon </a>','proficiency' ); ?></label> 
				...
				<td style="margin-bottom: 30px;">
                    <label for="<?php echo $this->get_field_id('service_title'); ?>"><?php _e('Service Title', 'proficiency'); ?></label>
                </td>
				<td>
				...
				<td>
                    <label for="<?php echo $this->get_field_id('service_desc'); ?>"><?php _e('Service Description', 'proficiency'); ?></label>
                </td>
				<td>
				...
				<p>
            <label for="<?php echo $this->get_field_id('image_uri'); ?>"><?php _e('Image', 'proficiency'); ?></label><br/>

            <?php

            if ( !empty($instance['image_uri']) ) :

                echo '<img class="custom_media_image_team" src="' . $instance['image_uri'] . '" style="margin:0;padding:0;max-width:100px;float:left;display:inline-block" alt="'.__( 'Uploaded image', 'proficiency' ).'" /><br />';
            ...
            <input type="button" class="button button-primary custom_media_button_team" id="custom_media_button_team" name="<?php echo $this->get_field_name('image_uri'); ?>" value="<?php _e('Upload Image','proficiency'); ?>" style="margin-top:5px;">
        </p>

        <p>
            <input type="checkbox" name="<?php echo $this->get_field_name('hide_image'); ?>" id="<?php echo $this->get_field_id('hide_image'); ?>" <?php if( !empty($instance['hide_image']) ): checked( (bool) $instance['hide_image'], true ); endif; ?> ><?php _e( 'Hide Featured Image','proficiency' ); ?>
            </p>
		<table>
        <tr>
        		<td>
