...
<div class="at-header-admin">
      <div class="at-logo-admin">
		  	...
		  	<span><?php echo esc_html__('V 1.1.0','pepe-lite');?></span>
		  </div>
...
<div class="pepe-tab-support">
	...
	<div id="Welcome" class="tabcontent">
		...
		<p class="pepe-welkome-support"><?php esc_html_e('Thank you for choosing Pepe Lite.','pepe-lite');?><br>
		  ...
		  <p class="pepe-welkome-support"><?php esc_html_e('For support: ','pepe-lite')?><a class="pepe-lite-supp-a-demo" target="_blank" href="<?php echo esc_url(pepe_url_support_theme)?>"><?php esc_html_e('Wordpress.org','pepe-lite')?></a></p>
		  <div class="container">
